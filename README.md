# USE APENAS A VERSÃO DA BRANCH DEVELOP NO BRMED
# A MASTER PRECISA SER ATUALIZADA COM DEVELOP !!!
# APENAS A FUNCIONALIDADE DE LOGAR MODOLEOS ESTÁ SENDO SUPORTADA PARA O NOSSO DJANGO(1.5.x)
